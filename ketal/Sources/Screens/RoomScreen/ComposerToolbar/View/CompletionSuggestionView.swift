    ...
    static var previews: some View {
        ...
        VStack(spacing: 8) {
            CompletionSuggestionView(mediaProvider: MediaProviderMock(configuration: .init()),
                                     items: [.init(suggestionType: .user(.init(id: "@user_mention_1:ketals.online", displayName: "User 1", avatarURL: nil)), range: .init(), rawSuggestionText: ""),
                                             .init(suggestionType: .user(.init(id: "@user_mention_2:ketals.online", displayName: "User 2", avatarURL: .mockMXCUserAvatar)), range: .init(), rawSuggestionText: "")]) { _ in }
        }
