...
class RoomEventStringBuilderTests: XCTestCase {
    ...
    func testSenderPrefix() {
        ...
        let otherMessageString = stringBuilder.buildAttributedString(for: makeMessageItem(senderID: "@bob:ketals.online", senderDisplayName: "Bob"))
        ...
        let ambiguousMessageString = stringBuilder.buildAttributedString(for: makeMessageItem(senderID: "@charlie:ketals.online",
                                                                                              senderDisplayName: "Charlie",
                                                                                              senderDisplayNameAmbiguous: true))
        XCTAssertEqual(ambiguousMessageString?.string, "Charlie (@charlie:ketals.online): Hello, World!",
        ...
        let otherEmoteString = stringBuilder.buildAttributedString(for: makeMessageItem(senderID: "@bob:ketals.online",
        ...
        let otherPollString = stringBuilder.buildAttributedString(for: makePollItem(senderID: "@bob:ketals.online", senderDisplayName: "Bob"))
