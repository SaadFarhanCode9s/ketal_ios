...
class AttributedStringBuilderTests: XCTestCase {
    ...
    func testRenderPlainStringWithLink() {
        let plainString = "This text contains a https://www.ketals.online link."
        ...
        XCTAssertEqual(link?.host, "www.ketals.online")
    }
    
    func testPunctuationAtTheEndOfPlainStringLinks() {
        let plainString = "Most punctuation marks are removed https://www.ketals.online:;., but closing brackets are kept https://example.com/(test)"
        ...
        XCTAssertEqual(firstLink, "https://www.ketals.online")
    ...
    func testLinkDefaultScheme() {
        let plainString = "This text contains a ketals.online link."
        ...
        XCTAssertEqual(link, "https://ketals.online")
    }
    
    func testMailToLinks() {
        let plainString = "Linking to email addresses like stefan@ketals.online should work as well"
        ...
        let link = attributedString.runs.first { $0.link != nil }?.link
        XCTAssertEqual(link, "mailto:stefan@ketals.online")
    }
    
    func testRenderHTMLStringWithLinkInHeader() {
        let h1HTMLString = "<h1><a href=\"https://ketals.online/\">ketals.online</a></h1>"
        let h2HTMLString = "<h2><a href=\"https://ketals.online/\">ketals.online</a></h2>"
        let h3HTMLString = "<h3><a href=\"https://ketals.online/\">ketals.online</a></h3>"
        ...
        XCTAssertEqual(String(h1AttributedString.characters), "ketals.online")
        XCTAssertEqual(String(h2AttributedString.characters), "ketals.online")
        XCTAssertEqual(String(h3AttributedString.characters), "ketals.online")
        ...
        XCTAssertEqual(h1AttributedString.runs.first?.link?.host, "ketals.online")
        XCTAssertEqual(h2AttributedString.runs.first?.link?.host, "ketals.online")
        XCTAssertEqual(h3AttributedString.runs.first?.link?.host, "ketals.online")
    }
    
    func testRenderHTMLStringWithIFrame() {
        let htmlString = "<iframe src=\"https://www.ketals.online/\"></iframe>"
    ...
    func testPermalink() {
        let string = "https://ketals.online/#/!hello:ketals.online/$world?via=ketals.online"
    ...
    func testMatrixURI() {
        let string = "matrix:roomid/hello:ketals.online/e/world?via=ketals.online"
        checkLinkIn(attributedString: attributedStringBuilder.fromHTML(string), expectedLink: string, expectedRuns: 1)
        checkLinkIn(attributedString: attributedStringBuilder.fromPlain(string), expectedLink: string, expectedRuns: 1)
    }
    
    func testUserIDLink() {
        let userID = "@user:ketals.online"
        let string = "The user is \(userID)."
        let expectedLink = "https://ketals.online/#/\(userID)"
    ...
    func testRoomAliasLink() {
        let roomAlias = "#room:ketals.online"
        let string = "The room is \(roomAlias)."
        guard let expectedLink = URL(string: "https://ketals.online/#/\(roomAlias)") else {
    ...
    func testDefaultForegroundColor() {
        let htmlString = "<b>Test</b> <i>string</i> <a href=\"https://www.ketals.online/\">link</a> <code><a href=\"https://www.ketals.online/\">link</a></code>"
    ...
    func testCustomForegroundColor() {
        ...
        for run in attributedString.runs {
            if run.link != nil {
                XCTAssertEqual(run.link?.host, "www.ketals.online")
                XCTAssertNil(run.uiKit.foregroundColor)
                foundLink = true
            } else {
                XCTAssertNil(run.uiKit.foregroundColor)
    ...
    func testBlockquoteWithLink() {
        let htmlString = "<blockquote>Blockquote with a <a href=\"https://www.ketals.online/\">link</a> in it</blockquote>"
    ...
    func testReplyBlockquote() {
        let htmlString = "<blockquote><a href=\"https://ketals.online/#/someroom/someevent\">In reply to</a> <a href=\"https://ketals.online/#/@user:ketals.online\">@user:ketals.online</a><br>The future is <code>swift run tools</code> 😎</blockquote>"
    ...
    func testUserPermalinkMentionAtachment() {
        ...
        XCTAssertEqual(attributedStringFromPlain?.userID, "@test:ketals.online")
        XCTAssertEqual(attributedStringFromPlain?.link?.absoluteString, string)
    }
    
    func testUserIDMentionAtachment() {
        let string = "@test:ketals.online"
        let attributedStringFromHTML = attributedStringBuilder.fromHTML(string)
        XCTAssertNotNil(attributedStringFromHTML?.attachment)
        XCTAssertEqual(attributedStringFromHTML?.userID, "@test:ketals.online")
        XCTAssertEqual(attributedStringFromHTML?.link?.absoluteString, "https://ketals.online/#/@test:ketals.online")
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        XCTAssertNotNil(attributedStringFromPlain?.attachment)
        XCTAssertEqual(attributedStringFromPlain?.userID, "@test:ketals.online")
        XCTAssertEqual(attributedStringFromPlain?.link?.absoluteString, "https://ketals.online/#/@test:ketals.online")
    }
    ...
    func testRoomIDPermalinkMentionAttachment() {
        ...
        let attributedStringFromHTML = attributedStringBuilder.fromHTML(string)
        XCTAssertNotNil(attributedStringFromHTML?.attachment)
        XCTAssertEqual(attributedStringFromHTML?.roomID, "!test:ketals.online")
        XCTAssertEqual(attributedStringFromHTML?.link?.absoluteString, string)
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        XCTAssertNotNil(attributedStringFromPlain?.attachment)
        XCTAssertEqual(attributedStringFromHTML?.roomID, "!test:ketals.online")
    ...
    func testRoomAliasPermalinkMentionAttachment() {
        ...
        let attributedStringFromHTML = attributedStringBuilder.fromHTML(string)
        XCTAssertNotNil(attributedStringFromHTML?.attachment)
        XCTAssertEqual(attributedStringFromHTML?.roomAlias, "#test:ketals.online")
        XCTAssertEqual(attributedStringFromHTML?.link?.absoluteString, "https://ketals.online/#/%23test:ketals.online")
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        XCTAssertNotNil(attributedStringFromPlain?.attachment)
        XCTAssertEqual(attributedStringFromHTML?.roomAlias, "#test:ketals.online")
        XCTAssertEqual(attributedStringFromPlain?.link?.absoluteString, "https://ketals.online/#/%23test:ketals.online")
    }
    ...
    func testEventRoomIDPermalinkMentionAttachment() {
        let string = "https://ketals.online/#/!test:ketals.online/$test"
        let attributedStringFromHTML = attributedStringBuilder.fromHTML(string)
        XCTAssertNotNil(attributedStringFromHTML?.attachment)
        XCTAssertEqual(attributedStringFromHTML?.eventOnRoomID, .some(.init(roomID: "!test:ketals.online", eventID: "$test")))
        XCTAssertEqual(attributedStringFromHTML?.link?.absoluteString, string)
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        XCTAssertNotNil(attributedStringFromPlain?.attachment)
        XCTAssertEqual(attributedStringFromPlain?.eventOnRoomID, .some(.init(roomID: "!test:ketals.online", eventID: "$test")))
        XCTAssertEqual(attributedStringFromPlain?.link?.absoluteString, string)
    }
    ...
    func testEventRoomAliasPermalinkMentionAttachment() {
        ...
        let attributedStringFromHTML = attributedStringBuilder.fromHTML(string)
        XCTAssertNotNil(attributedStringFromHTML?.attachment)
        XCTAssertEqual(attributedStringFromHTML?.eventOnRoomAlias, .some(.init(alias: "#test:ketals.online", eventID: "$test")))
        XCTAssertEqual(attributedStringFromHTML?.link?.absoluteString, "https://ketals.online/#/%23test:ketals.online/$test")
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        XCTAssertNotNil(attributedStringFromPlain?.attachment)
        XCTAssertEqual(attributedStringFromPlain?.eventOnRoomAlias, .some(.init(alias: "#test:ketals.online", eventID: "$test")))
        XCTAssertEqual(attributedStringFromPlain?.link?.absoluteString, "https://ketals.online/#/%23test:ketals.online/$test")
    }
    
    func testUserMentionAtachmentInBlockQuotes() {
        let link = "https://ketals.online/#/@test:ketals.online"
    ...
    func testLinksHavePriorityOverAllUserMention() {
        ...
        let string2 = "https://ketals.online/#/@roomusername:ketals.online"
        let attributedStringFromHTML2 = attributedStringBuilder.fromHTML(string2)
    ...
    func testURLsAreIgnoredInCode() {
        var htmlString = "<pre><code>test https://ketals.online test</code></pre>"
        ...
        htmlString = "<pre><code>ketals.online</code></pre>"
    ...
    func testHyperlinksAreIgnoredInCode() {
        let htmlString = "<pre><code>test <a href=\"https://ketals.online\">matrix</a> test</code></pre>"
        let attributedStringFromHTML = attributedStringBuilder.fromHTML(htmlString)
        XCTAssertNil(attributedStringFromHTML?.link)
    }
    
    func testUserMentionIsIgnoredInCode() {
        let htmlString = "<pre><code>test https://ketals.online/#/@test:ketals.online test</code></pre>"
    ...
    func testPlainTextUserMentionIsIgnoredInCode() {
        let htmlString = "<pre><code>Hey @some.user.ceriu:ketals.online</code></pre>"
        let attributedString = attributedStringBuilder.fromHTML(htmlString)
    ...
    func testMultipleMentions() {
        guard let url = URL(string: "https://ketals.online/#/@test:ketals.online") else {
            XCTFail("Invalid url")
            return
        }
    ...
    func testPhishingLink() {
        let htmlString = "Hey check the following link <a href=\"https://ketals.online\">https://element.io</a>"
        ...
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://ketals.online")
        XCTAssertEqual(link.confirmationParameters?.displayString, "https://element.io")
    }
    
    func testValidLink() {
        let htmlString = "Hey check the following <a href=\"https://ketals.online\">link</a>"
        ...
        XCTAssertEqual(link.absoluteString, "https://ketals.online")
    }
    
    func testValidLinkWithRTLOverride() {
        let htmlString = "<a href=\"https://ketals.online\">\u{202E}https://ketals.online</a>"
    ...
    func testPhishingUserID() {
        let htmlString = "Hey check the following user <a href=\"https://ketals.online\">@alice:ketals.online</a>"
        ...
        XCTAssertEqual(String(attributedString.characters), "Hey check the following user @alice:ketals.online")
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://ketals.online")
        XCTAssertEqual(link.confirmationParameters?.displayString, "@alice:ketals.online")
    }
    
    func testValidUserIDLink() {
        let htmlString = "Hey check the following user <a href=\"https://ketals.online/#/@alice:ketals.online\">@alice:ketals.online</a>"
        ...
        XCTAssertFalse(link.requiresConfirmation)
        XCTAssertEqual(link.absoluteString, "https://ketals.online/#/@alice:ketals.online")
    }
    
    func testPhishingUserIDWithAnotherUserIDPermalink() {
        let htmlString = "Hey check the following user <a href=\"https://ketals.online/#/@bob:ketals.online\">@alice:ketals.online</a>"
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://ketals.online/#/@bob:ketals.online")
        XCTAssertEqual(link.confirmationParameters?.displayString, "@alice:ketals.online")
    }
    
    func testPhishingUserIDWithDistractingCharacters() {
        let htmlString = "Hey check the following user <a href=\"https://ketals.online\">👉️ @alice:ketals.online</a>"
        ...
        XCTAssertEqual(String(attributedString.characters), "Hey check the following user 👉️ @alice:ketals.online")
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://ketals.online")
        XCTAssertEqual(link.confirmationParameters?.displayString, "👉️ @alice:ketals.online")
    }
    
    func testPhishingLinkWithDistractingCharacters() {
        let htmlString = "Hey check the following link <a href=\"https://ketals.online\">👉️ https://element.io</a>"
    ...
    func testPhishingMatrixPermalinks() {
        let htmlString = "Hey check the following room <a href=\"https://ketals.online/#/#offensive-room:ketals.online\">https://ketals.online/#/#beautiful-room:ketals.online</a>"
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://ketals.online/#/%23offensive-room:ketals.online")
        XCTAssertEqual(link.confirmationParameters?.displayString, "https://ketals.online/#/#beautiful-room:ketals.online")
    }
    
    func testValidMatrixPermalinks() {
        let htmlString = "Hey check the following room <a href=\"https://ketals.online/#/#beautiful-room:ketals.online\">https://ketals.online/#/#beautiful-room:ketals.online</a>"
        ...
        XCTAssertFalse(link.requiresConfirmation)
        XCTAssertEqual(link.absoluteString, "https://ketals.online/#/%23beautiful-room:ketals.online")
    }
    
    func testPhishingRoomAlias() {
        let htmlString = "Hey check the following room <a href=\"https://ketals.online\">#room:ketals.online</a>"
        ...
        XCTAssertEqual(String(attributedString.characters), "Hey check the following room #room:ketals.online")
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://ketals.online")
        XCTAssertEqual(link.confirmationParameters?.displayString, "#room:ketals.online")
    }
    
    func testValidRoomAliasLink() {
        let htmlString = "Hey check the following user <a href=\"https://ketals.online/#/#room:ketals.online\">#room:ketals.online</a>"
        ...
        XCTAssertFalse(link.requiresConfirmation)
        XCTAssertEqual(link.absoluteString, "https://ketals.online/#/%23room:ketals.online")
    }
    
    func testPhishingRoomAliasWithAnotherRoomAliasPermalink() {
        let htmlString = "Hey check the following room <a href=\"https://ketals.online/#/#another-room:ketals.online\">#room:ketals.online</a>"
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://ketals.online/#/%23another-room:ketals.online")
        XCTAssertEqual(link.confirmationParameters?.displayString, "#room:ketals.online")
    }
    
    func testRoomAliasWithDistractingCharacters() {
        let htmlString = "Hey check the following user <a href=\"https://ketals.online\">👉️ #room:ketals.online</a>"
        ...
        XCTAssertEqual(String(attributedString.characters), "Hey check the following user 👉️ #room:ketals.online")
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://ketals.online")
        XCTAssertEqual(link.confirmationParameters?.displayString, "👉️ #room:ketals.online")
    }

    func testMxExternalPaymentDetailsRemoved() {
        var htmlString = "This is visible.<span data-msc4286-external-payment-details> But this is hidden <a href=\"https://ketals.online\">and this link too</a></span>"
        ...
        htmlString = "This is visible.<span> And this text <a href=\"https://ketals.online\">and link</a> are visible too.</span>"
